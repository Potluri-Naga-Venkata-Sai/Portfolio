...
import {
  Trophy, Medal, Code, Award, ExternalLink, Flame, Target, Zap, Star,
} from "lucide-react";
...
const achievements = [
  {
    ...
    description: "Achieved the 50 Days coding badge on LeetCode through consistent daily problem solving.",
    icon: Flame,
    platform: "LeetCode",
  ...
  },
  {
    ...
    description: "Earned Gold Badge in Python programming demonstrating strong programming skills.",
    icon: Medal,
    platform: "HackerRank",
  ...
  },
  {
    ...
    description: "Gold badge in Problem Solving demonstrating strong algorithmic thinking.",
    icon: Target,
    platform: "HackerRank",
    link: "https://www.hackerrank.com/profile/nagavenkatasaip1",
  ...
  },
  {
    ...
    description: "Earned Gold Badge in C++ demonstrating proficiency in data structures and OOP.",
    icon: Code,
    platform: "HackerRank",
    link: "https://www.hackerrank.com/profile/nagavenkatasaip1",
...
const summaryStats = [
  { label: "Total Badges", value: "4+", icon: Award, color: "#facc15" },
  { label: "Problems Solved", value: "200+", icon: Code, color: "#34d399" },
  { label: "Platforms", value: "3+", icon: Zap, color: "#60a5fa" },
  { label: "Ranking", value: "Top 10%", icon: Star, color: "#f472b6" },
];
