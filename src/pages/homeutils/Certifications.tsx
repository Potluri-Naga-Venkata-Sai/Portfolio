...
const certifications = [
  {
    ...
    description: "Advanced Natural Language Processing including transformers, BERT and GPT.",
  ...
  },
  {
    ...
    issuer: "Algo Tutor Academy",
    description: "Training in data science and generative AI including LLMs.",
  ...
  },
  {
    ...
    title: "SQL (Basic)",
    issuer: "HackerRank",
    description: "Foundational SQL including queries, joins and aggregations.",
  ...
  },
  {
    ...
    issuer: "CSE Pathsha",
    description: "Complete C programming including pointers and memory management.",
  ...
  },
  {
    ...
    issuer: "freeCodeCamp",
    description: "Modern responsive design using HTML, CSS, Flexbox and Grid.",
