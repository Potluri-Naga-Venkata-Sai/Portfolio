...
const highlights = [
  ...
  },
  {
    ...
    description: 'LeetCode 50 Days Badge | HackerRank Gold Badge in Python',
    gradient: 'from-pink-500 to-rose-600',
    glow: 'rgba(255,80,160,0.15)',
  },
];
      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="text-center mb-16">
          ...
          <p className="about-bio text-lg md:text-xl text-foreground/70 max-w-3xl mx-auto leading-relaxed">
            ...
            Natural Language Processing, Data Science, and building intelligent systems that make
            a real-world impact. Currently pursuing B.Tech in Computer Science with specialisation
            in AI & ML.
          </p>
        </div>

        {/* ── Highlight cards ────────────────────────────────────────────────── */}
        <div className="about-cards grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {highlights.map((item) => (
            <div
              key={item.title}
